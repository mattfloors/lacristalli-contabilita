    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'leading-[normal]',
            {
                ...
                'text-sm py-1.5 px-2': props.size === 'small',
            ...
            // Plain Button
            {
                'text-white bg-surface-500 border border-surface-500':
            ...
            // Contrast Button
            {
                'text-white dark:text-surface-900 dark:text-white dark:hover:bg-surface-700 dark:hover:border-surface-700':
            ...
            // Primary
            {
                'hover:bg-primary-600 hover:bg-primary-600':
                    !props.link &&
                    props.severity === null &&
                    !props.text &&
                    !props.outlined &&
