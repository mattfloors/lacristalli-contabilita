export default {
    ...
    input: ({ props, parent, context }) => ({
        class: [
            ...
            { 'bg-white dark:bg-surface-800': !props.disabled },
            'border',
    ...
    weeklabelcontainer: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-surface-800 dark:text-surface-200 bg-transparent':
                    !context.selected && !context.disabled,
                'text-white bg-primary-400': context.selected && !context.disabled
            },
            ...
            'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 dark:focus:ring-primary-400 focus:z-10',
            {
                'hover:bg-surface-50 dark:hover:bg-surface-500/10':
                    !context.selected && !context.disabled,
                'hover:bg-primary-400': context.selected && !context.disabled
            },
            {
