export default {
    root: ({ props, state, parent }) => ({
        class: [
            ...
            { 'bg-surface-0 dark:bg-surface-800': !props.disabled },

            'border',
            { 'dark:border-surface-700': parent.instance.$name != 'InputGroup' && !props.invalid },
            { 'dark:border-surface-600': parent.instance.$name == 'InputGroup' && !props.invalid },
