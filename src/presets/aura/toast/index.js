export default {
    ...
    container: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                'bg-info-300/70 dark:bg-info-500/70': props.message.severity == 'info',
                'bg-success-300/70 dark:bg-success-500/70': props.message.severity == 'success',
                'bg-surface-50 dark:bg-surface-800': props.message.severity == 'secondary',
                'bg-warning-300/70 dark:bg-warning-500/70': props.message.severity == 'warn',
                'bg-error-300/70 dark:bg-error-500/70': props.message.severity == 'error',
            ...
            {
                'text-info-800 dark:text-info-300': props.message.severity == 'info',
                'text-success-800 dark:text-success-300': props.message.severity == 'success',
                'text-surface-800 dark:text-surface-300': props.message.severity == 'secondary',
                'text-warning-800 dark:text-warning-300': props.message.severity == 'warn',
                'text-error-800 dark:text-error-300': props.message.severity == 'error',
    ...
    text: ({ props }) => ({
        class: [
            ...
            'ml-2',
            'flex-1',
            { 'flex justify-start items-center': !props.message.detail }
        ]
    }),
    summary: {
